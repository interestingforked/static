...
class Feast extends NonObject {
     ...
     * @return string
     */
    static function nameOfDay($day = NULL) {
    ...
    static function nameOfMonth($month = NULL) {
        if ($month === NULL) {
            $month = (int) date('n');
        }
     ...
     * @return date
     */
    static function czechDate2Sql($date = '01.01.1991') {
        if (empty($date))
            return NULL;
        $date = explode('.', $date);
     ...
     * @return number
     */
    static function age($day, $month, $year, $int = TRUE) {
     ...
     * @return int
     */
    static function februaryOfDay($year) {
     ...
     * @return \DateTime
     */
    static function easter($year = NULL, $monday = TRUE) {
        if ($year === NULL) {
            $year = date('Y');
        }
     ...
     * @return string
     */
    static function getName($day = NULL, $month = NULL) {
        if (is_string($day)) {
            $day = new \DateTime($day);
        }
